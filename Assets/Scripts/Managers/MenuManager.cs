...
public class MenuManager : MonoBehaviourPunCallbacks
{
    ...
    public void CreateRoom()
    {
        ...
        //{
        //    Debug.Log("Комната с таким именем уже существует");
        //}
        //else
        if (createInput.text == "")
            return;
    ...
    //Когда список комнат обновился, мы в меню тоже обновляем все комнаты
    private void UpdateRoomList(List<RoomInfo> roomList)
    {
        DestroyItems(); //очищаем список
        RepopulateItems(roomList); //заполняем обновленными комнатами список
    }
